...
[wxID_FRAME4, wxID_FRAME4COMBOBOX1, wxID_FRAME4LISTBOX1, wxID_FRAME4PANEL1, 
 wxID_FRAME4STATICTEXT1, wxID_FRAME4STATICTEXT2, wxID_FRAME4STATICTEXT3, 
 wxID_FRAME4TEXTCTRL1, wxID_FRAME4TOGGLEBUTTON1, wxID_FRAME4TOGGLEBUTTON2, 
 wxID_FRAME4TOGGLEBUTTON3, wxID_FRAME4TYPELISTBOX, 
...
class Frame4(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_FRAME4, name='', parent=prnt,
              pos=wx.Point(6, 117), size=wx.Size(790, 587),
        ...
        self.toggleButton3 = wx.ToggleButton(id=wxID_FRAME4TOGGLEBUTTON3,
              ...
              pos=wx.Point(256, 408), size=wx.Size(88, 40), style=0)
        ...
        self.typeListBox = wx.ListBox(choices=[], id=wxID_FRAME4TYPELISTBOX,
              name=u'typeListBox', parent=self.panel1, pos=wx.Point(352, 288),
              size=wx.Size(112, 104), style=0)

        self.staticText3 = wx.StaticText(id=wxID_FRAME4STATICTEXT3,
              label=u'VARCHAR --- String\nREAL ---- Decimal',
              name='staticText3', parent=self.panel1, pos=wx.Point(368, 192),
              size=wx.Size(95, 26), style=1)
    ...
    def OnToggleButton1Togglebutton(self, event):
        ...
        if s1==s2:
            ...
            self.typeListBox.Append(self.comboBox1.GetValue())
