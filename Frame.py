...
[wxID_HOMEFRAME, wxID_HOMEFRAMEABORT, wxID_HOMEFRAMEALLTOGETHER, 
 wxID_HOMEFRAMEATTBLISTBOX, wxID_HOMEFRAMEBITMAPBUTTON1, 
 wxID_HOMEFRAMEBITMAPBUTTON2, wxID_HOMEFRAMEBITMAPBUTTON3, 
 wxID_HOMEFRAMEBITMAPBUTTON4, wxID_HOMEFRAMEBITMAPBUTTON5, 
 wxID_HOMEFRAMEBROWSEFILES, wxID_HOMEFRAMEBROWSE_CALIB, wxID_HOMEFRAMEBUTTON1, 
 wxID_HOMEFRAMEBUTTON2, wxID_HOMEFRAMEBUTTON3, wxID_HOMEFRAMEBUTTON4, 
 wxID_HOMEFRAMEBUTTON5, wxID_HOMEFRAMEBUTTON6, wxID_HOMEFRAMECALIBRATION, 
 wxID_HOMEFRAMECALIB_GAUGE, wxID_HOMEFRAMECANNY, wxID_HOMEFRAMECHANGE, 
 wxID_HOMEFRAMECONTOUR, wxID_HOMEFRAMECROP, wxID_HOMEFRAMEDIRBROWSEBUTTON1, 
 wxID_HOMEFRAMEDIRBROWSEBUTTON2, wxID_HOMEFRAMEDIRBROWSEBUTTON3, 
 wxID_HOMEFRAMEDIRBROWSEBUTTON4, wxID_HOMEFRAMEDRAWBUILD, 
 wxID_HOMEFRAMEFILEBROWSEBUTTON1, wxID_HOMEFRAMEFINISH, 
 wxID_HOMEFRAMEFOOTPRINTEX, wxID_HOMEFRAMEFOOTPROCESS, 
 ...
 wxID_HOMEFRAMEPANEL5, wxID_HOMEFRAMEPANEL6, wxID_HOMEFRAMEPLACEMARK, 
 wxID_HOMEFRAMEPROCEED, wxID_HOMEFRAMERESULT, wxID_HOMEFRAMERICHTEXTCTRL1, 
 ...
 wxID_HOMEFRAMESHOW, wxID_HOMEFRAMESTATICTEXT1, wxID_HOMEFRAMESTATICTEXT2, 
 wxID_HOMEFRAMESTATICTEXT3, wxID_HOMEFRAMESTATICTEXT4, 
 wxID_HOMEFRAMESTATUSBAR, wxID_HOMEFRAMETEXTCTRL1, wxID_HOMEFRAMETEXTCTRL2, 
 wxID_HOMEFRAMEVISUALISEGAUGE, wxID_HOMEFRAMECOMBO_BOX_SENSE,wxID_HOMEFRAMEVISUALISEGE, 
] = [wx.NewId() for _init_ctrls in range(69)]

[wxID_HOMEFRAMEHELPABOUT, wxID_HOMEFRAMEHELPHELP, 
...
class homeFrame(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_HOMEFRAME, name=u'homeFrame',
              parent=prnt, pos=wx.Point(88, 89), size=wx.Size(936, 639),
        ...
        self.placemark = wx.Button(id=wxID_HOMEFRAMEPLACEMARK,
              label=u'Apply Placemarks + \nEnter the values in Database',
              name=u'placemark', parent=self.panel5, pos=wx.Point(480, 392),
              size=wx.Size(256, 48), style=0)
        ...
        self.textCtrl2 = wx.TextCtrl(id=wxID_HOMEFRAMETEXTCTRL2,
              ...
              size=wx.Size(416, 40), style=0, value=u'EnterQueryHere')
        ...
        self.button2 = wx.Button(id=wxID_HOMEFRAMEBUTTON2, label=u'Submit',
...
##################camera calibration
    ...
    def OnButton2Button(self, event):
        ...
        for row in dbcursor.execute('''SELECT * FROM information where '''+q):
            self.listBox1.Append(str(row))
